...
face_recognizer.read(r'C:\Users\Rakshi\Desktop\FaceRecogn\trainingData.yml')    #Give path of where trainingData.yml is saved

cap=cv2.VideoCapture(0)   #If you want to recognise face from a video then replace 0 with video path

name={0:"Harish",-1:"Not Recognise"}    #Change names accordingly.  If you want to recognize only one person then write:- name={0:"name"} thats all. Dont write for id number 1.
notRecogn=0
multFace=0
recognFace=0
noFace=0
